...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"navbar navbar-default\">\n  <div class=\"container\">\n    <div id=\"navbar-main\">\n      <ul class=\"nav navbar-nav\">\n        <li><a routerLink=\"/\" class=\"btn btn-primary\">Home</a></li>\n      </ul>\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li *ngIf=\"!auth.isLoggedIn()\"><a routerLink=\"/login\" class=\"btn btn-primary\">Sign in</a></li>\n        <li *ngIf=\"auth.isLoggedIn()\"><a routerLink=\"/profile\" class=\"btn btn-primary\">{{ auth.getUserDetails()?.name }}</a></li>\n        <li *ngIf=\"auth.isLoggedIn()\"><a (click)=\"auth.logout()\" class=\"btn btn-primary\">Logout</a></li>\n      </ul>\n    </div>\n  </div>\n</div>\n\n<router-outlet></router-outlet>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>recipe works!</p>\n<div class=\"container\">\n    <div class=\"row\">\n        <p>recipe:</p>\n        <p> {{recipeTitle}} </p>\n\n    </div>\n</div>");
...
let RecipeAPIService = class RecipeAPIService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    getRecipe() {
        return this.httpClient.get('https://www.themealdb.com/api/json/v1/1/search.php?s=Arrabiata').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res));
    }
};
RecipeAPIService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _recipe_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../recipe-api.service */ "./src/app/recipe-api.service.ts");
...
RecipeComponent.ctorParameters = () => [
    { type: _recipe_api_service__WEBPACK_IMPORTED_MODULE_2__["RecipeAPIService"] }
];
RecipeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_recipe_api_service__WEBPACK_IMPORTED_MODULE_2__["RecipeAPIService"]])
], RecipeComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Walker\Documents\Projects\RecipeMe\RecipeMe\client\src\main.ts */"./src/main.ts");
